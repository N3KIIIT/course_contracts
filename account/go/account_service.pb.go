...
import (
	_go "github.com/N3KIIIT/contracts/pagination/go"
...
const file_account_service_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xf9\x03\n" +
	"\aAccount\x12a\n" +
	"\n" +
	"CreateUser\x12\x1a.account.CreateUserRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14account/api/v1/users\x12_\n" +
	"\aGetUser\x12\x17.account.GetUserRequest\x1a\x18.account.GetUserResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19account/api/v1/users/{id}\x12]\n" +
	"\bGetUsers\x12\x18.account.GetUsersRequest\x1a\x19.account.GetUsersResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14account/api/v1/users\x12f\n" +
	"\n" +
	"UpdateUser\x12\x1a.account.UpdateUserRequest\x1a\x16.google.protobuf.Empty\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19account/api/v1/users/{id}\x12c\n" +
	"\n" +
	"DeleteUser\x12\x1a.account.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"!\x82\xd3\xe4\x93\x02\x1b*\x19account/api/v1/users/{id}B1Z/github.com/N3KIIIT/contracts/account/go;accountb\x06proto3"
